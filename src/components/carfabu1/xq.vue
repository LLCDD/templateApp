...
export default {
  ...
  methods: {
    ...
    cha() {
      ...
      this.value1 = str;
      this.http
        .post("/admin/api/selectUsersAndMessage.do", {
    ...
    open(uuid, id) {
      ...
      this.id = id;
      this.http
        .post("/admin/api/updateMessageData.do", {
          uuid: this.uuid,
          id: this.id,
          audit: 4,
          reason: "死数据"
    ...
    pre(e) {
      console.log(e);
      this.http
        .post("admin/api/selectUsersByIdMes.do.do", {
          releasetime: this.value1,
          describe: this.input1,
          phone: this.phone,
          pageNo: e
    ...
    one() {
      this.http
        .post("admin/api/selectUsersByIdMes.do", {
          releasetime: this.value1,
          describe: this.input1,
          phone: this.phone,
          uuid: this.uuid
